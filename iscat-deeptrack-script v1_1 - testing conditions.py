...
import iscat_deeptrack_v1_1 as iscat

''' NOTE!! THIS SHOULD BE RUN IN THE ''erik' environment.
    to start, open a conda terminal and type "conda activate erik"  '''
...
binfile = r"D:/_DATA FOLDER_/Github example data/2023-05-26-50nm PS 0.1nM ITO pH7 Laser150mW - sq/VIDEOS/2023-05-26_16-04-32_raw_12_256_200.bin"
...
constants["output path"]        = os.path.join(basepath, (name[:19] + " deeptrack " + iscat.getVersion()))
constants["name"]               = name
constants["fps"]                = fps
constants["fov"]                = fov
...
#constants["min confidence"]         = 0.25 #0.45 # good for contrast accuracy     # 0.3 #good compromise #0.05 # good for exploratory dialing back
...
r8, r16, noise = iscat.ratio_only(binimages, constants, return_v16=True)
